...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const title = settings?.title || 'Le journal'
    const description = settings?.description || "Conseils, anecdotes et réflexions sur l'apprentissage du piano à l'âge adulte."
...
const defaultSettings = {
  enabled: true,
  title: 'Le journal',
  description: "Conseils, anecdotes et réflexions sur l'apprentissage du piano à l'âge adulte.",
  eyebrow: 'Le journal',
}
